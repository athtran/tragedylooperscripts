class ScriptsController < ApplicationController
  ...
  private
    ...
    def script_params
      params.require(:script).permit(:title, :description, :cast, :incident, :main_plot, :subplot_1, :subplot_2, :tragedy_set, :num_loops, :days_loop, :special_rule, :cast_1, :cast_2, :cast_3, :cast_4, :cast_5, :cast_6, :cast_7, :cast_8, :cast_9, :cast_10, :cast_11, :cast_12, :role_1, :role_2, :role_3, :role_4, :role_5, :role_6, :role_7, :role_8, :role_9, :role_10, :role_11, :role_12, :day_1, :day_2, :day_3, :day_4, :day_5, :day_6, :day_7, :day_8, :culprit_1, :culprit_2, :culprit_3, :culprit_4, :culprit_5, :culprit_6, :culprit_7, :culprit_8)
    end
end
